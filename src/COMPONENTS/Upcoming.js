...
function Upcoming() 
{
  ...
  return (
    <div>
        ...
        <h2 style={{color: "white", fontSize: "20px", fontWeight: "900"}}>UPCOMING MOVIES</h2>
        ...
        <div className='trendingdiv' style={{display: "flex", flexWrap:'wrap', overflowX: "scroll"}}>
        {
            Movies.map(function(i,index)
            {
              ...
              <img style={{margin: "6px"}} height="300px" width="250px" src={"https://image.tmdb.org/t/p/original"+i.posterpath} />
