...
//         <h2 style={{color: "white", fontSize: "20px", fontWeight: "900"}}>TV</h2>
...
//               <img id='homeimages' style={{margin: "6px"}} height="300px" width="250px" src={"https://image.tmdb.org/t/p/original"+i.poster_path} />
...
function Action(props) {
  ...
  return (
    <div  style={{marginTop:'20px'}}  >
      <h2 style={{ color: 'white', fontSize: '20px', fontWeight: '900' }}>TV SHOWS</h2>
      {fetchedVideoID && <YouTube videoId={fetchedVideoID} opts={additionalData} />}
